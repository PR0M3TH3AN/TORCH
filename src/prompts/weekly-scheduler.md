...
| 12 | race-condition-agent | `race-condition-agent.md` |
| 13 | refactor-agent | `refactor-agent.md` |
| 14 | repo-fit-agent | `repo-fit-agent.md` |
| 15 | smoke-agent | `smoke-agent.md` |
| 16 | telemetry-agent | `telemetry-agent.md` |
| 17 | test-coverage-agent | `test-coverage-agent.md` |
| 18 | ui-ux-agent | `ui-ux-agent.md` |
| 19 | weekly-synthesis-agent | `weekly-synthesis-agent.md` |
