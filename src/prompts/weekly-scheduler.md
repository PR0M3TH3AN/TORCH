...
| 16 | smoke-agent | `smoke-agent.md` |
| 17 | telemetry-agent | `telemetry-agent.md` |
| 18 | test-coverage-agent | `test-coverage-agent.md` |
| 19 | ui-ux-agent | `ui-ux-agent.md` |
| 20 | weekly-synthesis-agent | `weekly-synthesis-agent.md` |
